 ...
 */
add_filter( 'dynamic_sidebar_params', 'rock_widget_classes' );

if ( ! function_exists( 'rock_widget_classes' ) ) {
	/**
	 ...
	 * @return array $params
	 */
	function rock_widget_classes( $params ) {
...
} // endif function_exists( 'rock_widget_classes' ).

add_action( 'widgets_init', 'rock_widgets_init' );

if ( ! function_exists( 'rock_widgets_init' ) ) {
	/**
	...
	function rock_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'rockcontent' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'rockcontent' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'rockcontent' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'rockcontent' ),
...
} // endif function_exists( 'rock_widgets_init' ).
